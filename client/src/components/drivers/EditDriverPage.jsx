  ...
  const fetchDriver = async () => {
    try {
      ...
      setFormData({
        ...
        permitExpiry: driverData.permitExpiry ? new Date(driverData.permitExpiry).toISOString().split('T')[0] : '',
        medicalExpiry: driverData.medicalExpiry ? new Date(driverData.medicalExpiry).toISOString().split('T')[0] : '',
        status: driverData.status || 'Active',
        experience: driverData.experience ? driverData.experience.toString() : '',
        salary: driverData.salary ? driverData.salary.toString() : '',
