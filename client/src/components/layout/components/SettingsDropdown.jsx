...
const SettingsDropdown = () => {
  ...
  const settingsOptions = [
    ...
    },
    {
      ...
      description: 'Set default commission rates for transporters',
      action: () => console.log('Commission Rates clicked')
    },
    {
      ...
      description: 'Manage booking and payment notifications',
      action: () => console.log('Notification Preferences clicked')
    },
    {
      name: 'System Reports',
      icon: (
      ...
      action: () => console.log('System Reports clicked')
    },
    {
      name: 'Help & Support',
      icon: (
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-2 w-72 bg-white rounded-lg shadow-lg border border-gray-100 z-50 animate-slideDown">
